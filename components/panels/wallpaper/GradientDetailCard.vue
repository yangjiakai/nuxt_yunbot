...
const changeBgColor = () => {
  appStore.currentBackground = `linear-gradient(${angle.value}deg, ${gradientFrom.value}, ${gradientTo.value})`;
};
</script>
  ...
  >
    ...
    <div class="card-header">
      <div class="center-area">
        ...
        <Icon class="right-icon" name="akar-icons:circle-chevron-right-fill" />
        <div class="gradient-to" @click="copy(gradientTo)">
          <!-- <copy-label :text="gradientTo" /> -->
          <span>{{ gradientTo }}</span>
        </div>
      </div>
    </div>
    <!-- ---------------------------------------------- -->
